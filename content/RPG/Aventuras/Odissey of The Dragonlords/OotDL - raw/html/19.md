...
date: 2025-11-27
---
<div data-roll-name-ancestor="Appendix D: Dramatis Personae" class="rd__b  rd__b--0">
    <h1 class="rd__h rd__h--0" data-title-index="2114"><span class="entry-title-inner">Appendix D: Dramatis Personae</span></h1>
    ...
    <div data-roll-name-ancestor="The Elder Titans" class="rd__b  rd__b--0">
        <h1 class="rd__h rd__h--0" data-title-index="2115"><span class="entry-title-inner">The Elder Titans</span></h1>
        <div data-roll-name-ancestor="Thylea" class="rd__b  rd__b--1">
            <h2 class="rd__h rd__h--1" data-title-index="2116"><span class="entry-title-inner">Thylea</span></h2>
        ...
        <p>@UUID[Actor.0i9gBrcDEDDNzdbo]{Kentimane}</p>
    </div>
    <hr class="rd__hr rd__hr--section">
    <div data-roll-name-ancestor="The Titans" class="rd__b  rd__b--0">
        <h1 class="rd__h rd__h--0" data-title-index="2117"><span class="entry-title-inner">The Titans</span></h1>
        <p>@UUID[Actor.Ji655uZeSHEnahm6]{Lutheria}</p>
        <p>@UUID[Actor.o5ja8lQsmKUi9cur]{Sydon}</p>
    </div>
    <hr class="rd__hr rd__hr--section">
    <div data-roll-name-ancestor="The Five Gods" class="rd__b  rd__b--0">
        <h1 class="rd__h rd__h--0" data-title-index="2118"><span class="entry-title-inner">The Five Gods</span></h1>
        ...
        <p>Mytros is the wellspring of their divine power. She ascended to true godhood when she sacrificed herself to forge the Oath of Peace. For the complete story, refer to the @UUID[JournalEntry.7m2DKMOVDmoiCd7q.JournalEntryPage.0000000000000025]{Secrets and Myths} appendix.</p>
        <div data-roll-name-ancestor="Mytros, Goddess of Dawn" class="rd__b  rd__b--1">
            <h2 class="rd__h rd__h--1" data-title-index="2119"><span class="entry-title-inner">Mytros, Goddess of Dawn</span></h2>
            ...
            <div data-roll-name-ancestor="Mytros&#x27;s True Form" class="rd__b  rd__b--2">
                <h3 class="rd__h rd__h--2" data-title-index="2120"><span class="entry-title-inner">Mytros's True Form</span></h3>
        ...
        <p>@UUID[Actor.eonpUkqA7uqSWg7C]{Volkan, God of Forges}</p>
        <p>@UUID[Actor.d5MCCh939OlZevLX]{Kyrah, Goddess of Music}</p>
        <p>@UUID[Actor.06dPRlg8T5DuJfcO]{Pythor, God of Battle}</p>
        <p>@UUID[Actor.KsTXBBUZvdcBAdj7]{Vallus, Goddess of Wisdom}</p>
    </div>
    <hr class="rd__hr rd__hr--section">
    <div data-roll-name-ancestor="Mortals" class="rd__b  rd__b--0">
        <h1 class="rd__h rd__h--0" data-title-index="2121"><span class="entry-title-inner">Mortals</span></h1>
        <p>@UUID[Actor.zDkzE4FoGb4eWl1K]{Acastus, King of Mytros}</p>
        <p>@UUID[Actor.6KpPDuLeITdj4uU7]{Bullbug the Minotaur}</p>
        <p>@UUID[Actor.Eo6b7iHlH6uheKgb]{Estor Arkelander}</p>
        <p>@UUID[Actor.5FT7yL2QjW27Z8rZ]{Commander Gaius}</p>
        <p>@UUID[Actor.FesLRKq7dZjwp239]{Loreus the Satyr}</p>
        <p>@UUID[Actor.hjcKzWTHOIpIsEck]{Moxena, The Lady of Coins}</p>
        <p>@UUID[Actor.dU50khGuWXURUZrI]{Nessa the Centaur}</p>
        <p>@UUID[Actor.S1Fexy4g25rukHsa]{Pholon the Centaur}</p>
        <p>@UUID[Actor.4ouVdo6vI49nbTwW]{Steros the Jancan}</p>
        <p>@UUID[Actor.PFQ9aqlOiAC9V20h]{Versi the Oracle}</p>
        <p>@UUID[Actor.FLYoFKrbd2gKJat3]{Aesop}</p>
        <p>@UUID[Actor.Xh8OtkbR88d0ih7S]{Darien}</p>
        <p>@UUID[Actor.3T6kuEqbvnmPyOGm]{Chondrus}</p>
    </div>
</div>