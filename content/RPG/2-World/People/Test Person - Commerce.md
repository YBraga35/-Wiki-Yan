---
MyContainer: "[[2-World/Places/Test Place - Commerce.md|Test Place - Commerce]]"
MyCategory:
...
Race(s): `INPUT[text:char_race]`
Level: `INPUT[number:level]`
Initiative: `INPUT[number:init]`
Endurance: `INPUT[number:hits]` Damage: `INPUT[number:damage]`
Power Points: `INPUT[number:PP]`

## Resistance Rolls
Stamina: `INPUT[number:StaminaRR]`
Will: `INPUT[number:WillRR]`
Magic: `INPUT[number:MagicRR]`
